...
| [`decision-consultant`](decision-consultant/README.md) | Opt-in Jev/Kev (System One) second-opinion gate before configured tool calls; shadow by default, never grants approval | — |
